...
?>
<a href="?page=registerdata" class="button">Kembali</a>
...
foreach($items as $item){
		...
		if(!empty($item['id_data_pribadi'])){
							...
							<tr>
									...
									<?php if (ucwords(str_replace('_', ' ', alias($pribadi_k2))) == "Photo"){?>
										...
										<?php if(alias($data_pribadi->$pribadi_k2) != "") { ?>
											<img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'] . alias($data_pribadi->$pribadi_k2)?>" width="100px" height="100px">
										<?php } else { ?>
											photo
										<?php } ?>
										</td>
			...
			?>
					<tr><td colspan="4" style="width:30%;font-weight:bold"><h3 style="margin:0;padding:0;line-height:20px;text-transform:uppercase">LEMBAR TANDA TANGAN</h3></td></tr>					
							<tr>
								<td colspan="4">TANGGAL : <?php echo Date("d/m/Y"); ?><br>TANDA TANGAN NASABAH<br><br><br><br><br><?php echo $nama; ?></td>
							</tr>
			</table>
			<!-- ======================= -->
		...
		if(!empty($item['id_form_simpanan'])){
			...
			?>
					<tr><td colspan="4" style="width:30%;font-weight:bold"><h3 style="margin:0;padding:0;line-height:20px;text-transform:uppercase">LEMBAR TANDA TANGAN</h3></td></tr>					
							<tr>
								<td colspan="4">TANGGAL : <?php echo Date("d/m/Y"); ?><br>TANDA TANGAN NASABAH<br><br><br><br><br><?php echo $namaLengkap; ?></td>
							</tr>
			</table>
			<?php 
		}
		if(!empty($item['id_form_atm_sms'])){
			...
			?>
					<tr><td colspan="4" style="width:30%;font-weight:bold"><h3 style="margin:0;padding:0;line-height:20px;text-transform:uppercase">LEMBAR TANDA TANGAN</h3></td></tr>					
							<tr>
								<td colspan="4">TANGGAL : <?php echo Date("d/m/Y"); ?><br>TANDA TANGAN NASABAH<br><br><br><br><br><?php echo $namaAtmSms; ?></td>
							</tr>
			</table>
			<?php 
		}		
