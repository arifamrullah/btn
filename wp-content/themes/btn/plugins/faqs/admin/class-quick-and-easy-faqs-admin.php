...
class Quick_And_Easy_FAQs_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_theme_url(__FILE__) . '/css/quick-and-easy-faqs-admin.css', array( 'wp-color-picker' ), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
        wp_enqueue_script( $this->plugin_name, plugin_dir_theme_url(__FILE__). 'js/quick-and-easy-faqs-admin.js', array( 'jquery' , 'wp-color-picker' ), $this->version, false );
	}
