...
#adminmenu a:hover, #adminmenu li.menu-top:hover, #adminmenu li.opensub>a.menu-top, #adminmenu li>a.menu-top:focus{
 background:<?php echo $fau_primary; ?> !important;
 
}

#adminmenu a:hover  div.wp-menu-image:before,#adminmenu a:hover div.wp-menu-name{
  color: #FFF !important; 
}
...
#wp-admin-bar-oc-admin-chat-title{height:33px !important}
#wp-admin-bar-search,#wp-admin-bar-new-media,#wp-admin-bar-comments,#wp-admin-bar-updates,#toplevel_page_wpfront-user-role-editor-all-roles,#menu-tools,#menu-plugins,#menu-comments,#menu-media{display:none !important}
