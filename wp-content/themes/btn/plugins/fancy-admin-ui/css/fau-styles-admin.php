...
#adminmenu li a:focus div.wp-menu-image:before,#adminmenu li.opensub div.wp-menu-image:before,#adminmenu li:hover div.wp-menu-image:before {
  color: <?php echo $fau_primary; ?>!important;
}
...
#dashboard_right_now,#dashboard_primary,#welcome-panel{display:none}

#menu-appearance,#menu-settings,#contextual-help-link-wrap,.hide-if-no-customize, #menu-dashboard .wp-submenu,#wp-admin-bar-search,#wp-admin-bar-new-media,#wp-admin-bar-comments,#wp-admin-bar-updates,#toplevel_page_wpfront-user-role-editor-all-roles,#menu-tools,#menu-plugins,#menu-comments,#menu-media{display:none !important}


#footer-upgrade,.update-nag{display:none}
#form-pendaftaran{
  padding-top: 28px !important;
  margin-bottom: 30px !important;
}

.tablenav {height:auto !important}