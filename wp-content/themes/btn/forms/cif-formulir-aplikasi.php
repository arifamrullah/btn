            ...
            <div class="form-child" id="cifFormulirRekening">
              <form id="registrasiAtmSms" class="form-horizontal">
                <div class="data-diri">
                        ...
                        <tbody>                            
                            ...
                            <tr>
                              ...
                              <td width="60%" class="tdgenap">
                                <div class="row">
                                  <div class="col-sm-5">
                                    <input type="text" name="tempat_lahir_aplikasi" maxlength="255" size="27"  value="" class="formfield required upper">
                                  </div>
                                  <div class="col-sm-7">
                            ...
                            <tr>
                              ...
                              <td width="60%" class="tdgenap">
                                <input type="text" maxlength="255" size="68" name="no_kartu_aplikasi" value="" class="formField number_only">
                              </td>
                            </tr>
                            <tr>
                              <td width="40%" class="tdganjil"><strong>No CIF</strong></td>
                              <td width="60%" class="tdgenap">
                                <input type="text" maxlength="255" name="no_cif_aplikasi" size="68" value="" class="formField">
                              </td>
                            </tr>
                        </tbody>
                    </table>
                  ...
                  <div id="kartu_btn">
                    ...
                    <table class="table">
                        <tbody>                            
                            ...
                            <td width="60%" class="tdgenap"><label>Nama Pada Kartu<span>*</span> </label> <input type="text" maxlength="255" name="nama_pada_kartu" size="51" value="" class="formField required upper" onkeypress="return nameKartuVlidate(event,this.value)"></td>
                            </tr>
                            <tr>
                  ...
                  <div id="sms_banking" style="display:none">
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            Rp. <input type="text" maxlength="255" name="pendebetan_lebih"  value="" class="formField">
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            Rp. <input type="text" maxlength="255" name="pengkreditan_lebih_dari"  value="" class="formField">
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            Rp. <input type="text" maxlength="255" name="saldo_kurang_dari" value="" class="formField">
                          </td>
                          <td>
                ...
                <div class="row">
                  ...
                  <div class="box-btn">
                    <div id="captchaimage">
                      <a href="javascript:void(0)" id="refreshimg" title="Click to refresh image">
                        <img src="<?php echo get_template_directory_uri();?>/inc/captcha/image.php?token=<?php echo btn_ajax_create_captcha() ?>" width="132" height="46" alt="Captcha image">
                      </a>
                    </div>
                    ...
                    <a href="javascript:void(0)" id="SubmitProsesCifRegistrasiWithAtm" class="btn btn-success">Save</a>
                  </div>
